...
> Roadmap **[Sprint 29](../project/roadmap.md#sprint-29--transit--travel-systems)** (see [`roadmap.md`](../project/roadmap.md)).
...
>
> **Tier 1 dependencies (build first — [`engine_core.md`](../engine/engine_core.md)):** the **route
> runner** (`RouteSpec`/`MobileRouteState`/`MobileRouteService` + `RouteHooks`, engine_core
> §3.8, [Sprint 21](../project/roadmap.md#sprint-21--scheduled-moving-entity-moving-room)) owns the
...
>
> **Pillars this serves** (see [`wishlist.md`](../project/wishlist.md) → *Design pillars*): **Exploration**
> (the network *is* how you reach new areas) and **Trading** — the signature pairing is
> *transit network = trade network*: regional price differences ([`roadmap.md`](../project/roadmap.md)
> [Sprint 28](../project/roadmap.md#sprint-28--trading--economy)) only matter if getting goods between towns takes time, money, and planning.
...
- **`Item`** — tickets are items (gating boarding); fares tie to the [Sprint 28](../project/roadmap.md#sprint-28--trading--economy) currency model.
- **Pluggable conditions / side-effects** registries ([Sprint 10](../project/roadmap.md#sprint-10--extensibility-seams-)) and the
...
- Tickets are sold by vendor NPCs ([Sprint 28](../project/roadmap.md#sprint-28--trading--economy) shops); fare pricing rides on the [Sprint 28](../project/roadmap.md#sprint-28--trading--economy)
...
- **Open:** fare = flat per-line or per-segment distance? (Lean: flat per boarding until the
  [Sprint 28](../project/roadmap.md#sprint-28--trading--economy) economy says otherwise.)

---

*See [`roadmap.md`](../project/roadmap.md) [Sprint 29](../project/roadmap.md#sprint-29--transit--travel-systems), [`wishlist.md`](../project/wishlist.md) → Featured idea, and
