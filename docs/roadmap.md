...
- **In progress:** 66 (multi-level map foundation — `map_z`) — scoped 2026-07-09.
- **In progress:** 67 (webui-theming agent skill + `MODE_DEFAULT_THEME` single-sourcing
  fix) — scoped 2026-07-09.
- **Next new sprint after 67: 68.** Don't recycle a number that appears here or in
  [`roadmap_completed.md`](roadmap_completed.md).
