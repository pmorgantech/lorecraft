...
**See [`feature-registration.md`](feature-registration.md) for the full pattern.** In brief, create a package under `src/lorecraft/features/<my_feature>/`:
