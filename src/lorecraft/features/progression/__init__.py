...
Sprint 73 Phase 1 ships the config + schema + admin endpoint; the reward
interpreter and quest/level-up wiring land in later phases. No `register_fn`
yet — nothing to bind onto the shared registries until the interpreter exists.
"""
