"""Browser e2e: admin Issues tab default filter and sorting.
...
console in a headless browser to verify the client-side default filter (hide
resolved/deferred) and selectable sort.
"""
