...
QUERY_LOG_ENABLED="${LORECRAFT_DB_QUERY_LOG_ENABLED:-true}"
QUERY_LOG_PATH="${LORECRAFT_DB_QUERY_LOG_PATH:-${SCRIPT_DIR}/logs/sql_queries.log}"
QUERY_LOG_SLOW_MS="${LORECRAFT_DB_QUERY_SLOW_MS:-50.0}"
...
export LORECRAFT_DB_QUERY_LOG_ENABLED="${QUERY_LOG_ENABLED}"
export LORECRAFT_DB_QUERY_LOG_PATH="${QUERY_LOG_PATH}"
export LORECRAFT_DB_QUERY_SLOW_MS="${QUERY_LOG_SLOW_MS}"
mkdir -p "$(dirname "${LORECRAFT_DB_QUERY_LOG_PATH}")"
